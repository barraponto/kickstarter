...
mkdir data
time wget https://s3.amazonaws.com/weruns/forfun/Kickstarter/Kickstarter_2019-04-18T03_20_02_220Z.json.gz
time gunzip -c Kickstarter_2019-04-18T03_20_02_220Z.json.gz > ./data/kickstarter.json
...
time cd kickstarter
time pipenv run scrapy crawl -L INFO -a file=../data/deduped.csv -o ../data/scraped.csv ksdata

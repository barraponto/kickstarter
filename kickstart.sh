...
pipenv run csvgrep -c launched_at,deadline -r '^201[4-8]' -z 524288 ./data/us-clean.csv > ./data/us-years.csv
pipenv run csvcut -c id -z 524288 ./data/us-years.csv | sort | uniq -d > ./data/dupes-ids.csv
pipenv run csvgrep -c id -f ./data/dupes-ids.csv -z 524288 ./data/us-years.csv | pipenv run csvsort -z 524288 -c id > ./data/dupes.csv
pipenv run csvgrep -c id -f ./data/dupes-ids.csv -i -z 524288 ./data/us-years.csv > ./data/deduped.csv
python ./dedupe.py # appends deduped.csv with deduped rows
cd kickstarter
